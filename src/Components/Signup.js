...
export default function Signup(props) {
    ...
    const [credentials, setcredentials] = useState({name:"",email:"",password:""})
      ...
      const handleSignUp=async(e)=>{
        ...
        const response = await fetch("https://noteworxbackend.onrender.com/api/auth/createuser", {
            method: "POST",
            headers: {
  ...
  return (
    ...
    <div className="form form-signup">
                <form action="#">
                    ...
                    <button onClick={handleSignUp} type="submit" className="button">Register</button>
