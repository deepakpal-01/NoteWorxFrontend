...
export default function Login(props) {
    ...
    const goBack=()=>{
      ...
      const handleLogin=async(e)=>{
        ...
        const response = await fetch("https://noteworxbackend.onrender.com/api/auth/login", {
            method: "POST",
            headers: {
        ...
        if(success){
          ...
          props.setProgress(100)
            ...
            props.showAlert("Invalid Credentails,Try Again","danger")
            props.setProgress(100)
        }
        ...
        <i onClick={goBack} className="fa-solid fa-xmark form-close"></i>
            ...
            <div className="form form-log-in ">
                <form action="#">
                    ...
                    <button onClick={handleLogin} type="submit" className="button">Login Now</button>
